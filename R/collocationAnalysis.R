...
#' @examples
#' \dontrun{
#'  # top collocates of "Packung" outside and in sports domain
...
#'
#' \dontrun{
#'  # top collocates of "Maßnahme" in German and Swiss newspapers
#'  new("KorAPConnection", verbose = TRUE) %>%
#'   collocationAnalysis("Maßnahme", vc=sprintf("textType=/Zeit.*/ & pubPlaceKey=%s", c("DE", "CH")),
#'                       leftContextSize=1, rightContextSize=1, topCollocatesLimit=20) %>%
#'   dplyr::filter(logDice >= 5)
#' }
#'
