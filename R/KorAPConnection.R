...
#' @param accessToken OAuth2 access token. For textual queries on corpus parts
#'   for which KWIC access requires a login because of IPR or other restrictions,
#'   you need to authorize your application with an access token.
