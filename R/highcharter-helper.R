...
.onAttach <- function(libname = find.package("RKorAPClient"),
  ...
  packageStartupMessage(
    "If you intend to use the Highharts plot options, please note that Highcharts (www.highcharts.com) is a Highsoft software product which is not free for commercial and governmental use."
  )
}
